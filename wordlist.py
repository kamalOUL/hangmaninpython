words = ("aardvark", "alligator", "alpaca", "ant",
         "anteater", "antelope", "ape", "armadillo", "baboon",
         "badger", "bat", "bear", "beaver", "bee", "bison", "boar",
         "buffalo", "butterfly", "camel", "capybara",
         "caribou", "cat", "caterpillar", "cattle",
         "chamois", "cheetah", "chicken", "chimpanzee",
         "chinchilla", "chough", "clam", "cobra", "cockroach"
         , "cod", "coyote", "crab", "crane", "crocodile",
         "crow", "curlew", "deer", "dinosaur", "dog",
         "dogfish", "dolphin", "donkey", "dormouse", "dotterel",
         ...
         , "heron", "herring", "hippopotamus", "hornet", "horse", "human",
         ...
         , "llama", "lobster", "locust", "loris", "louse", "lyrebird",
         ...
         "opossum", "oryx", "ostrich", "otter", "owl", "ox", "oyster", "panda",
         ...
         "squid", "squirrel", "starling", "stingray", "stoat", "stork", "swallow",
